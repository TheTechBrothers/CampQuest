...
public class FirebaseAuthenticationFailureHandler implements AuthenticationFailureHandler {
    ...
    private static final Logger LOGGER = (Logger) LoggerFactory.getLogger(FirebaseAuthenticationFailureHandler.class);

    @Override
    public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response, AuthenticationException exception) throws IOException {
        LOGGER.log(Level.parse("Authentication failed: {}"), exception.getMessage());
